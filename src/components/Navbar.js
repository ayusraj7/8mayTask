...
const Navbar = () => {
  return (
    <div className='bg-[rgb(6,5,5)] text-white h-auto sm:h-[60px] justify-between flex px-[10%] py-1 items-center '>
        <IoLogoApple size={30} className='text-white' />
        <ul className=' hidden sm:flex flex-col sm:flex-row gap-4 md:gap-8 text-[18px]  '>
