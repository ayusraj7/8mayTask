...
const FirstPart = () => {
  return (
    <div className='bg-[rgb(6,5,5)] h-[89vh] md:h-[80vh] w-full text-white relative '>
        <div className='pt-[80px] px-[10%]'>
            <div className='flex flex-col w-[50%] gap-11'>
                <h1 className='text-5xl font-semibold leading-[55px] w-[80%]'>Discover Limitless Learning with Eduverse</h1>
        ...
        <div className='h-[130px] mt-6 py-3 text-black flex gap-8 bg-[rgb(207,240,197)] px-[10%]'>
        ...
        <img src={people} alt=""  className='absolute bottom-[-2%] w-[40%] right-[10%]'/>
    </div>
  )
}
